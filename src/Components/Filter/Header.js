...
class Header extends React.Component {
  ...
  render() {
    ...
    const isHome = window.location.href === "http://localhost:3000/";

    return (
      <div>
        <div className={`Navbar ${isHome ? "transparent" : ""}`}>
          <Link to="/" className={`e-circle ${isHome ? "transparent" : ""}`}>e!</Link>
          ...
          <div className="Menu">
            {fbLoggedIn ? (
              ...
              <>
                ...
                <div className={`Login ${isHome ? "transparent" : ""}`} onClick={() => this.setState({ loginModalIsOpen: true })}>
                  Login
                </div>
                <div className={`Newaccount ${isHome ? "transparent" : ""}`} onClick={() => this.setState({ signupModalIsOpen: true })}>
                  Create an account
                </div>
              </>
            )}
          ...
          <div className="parent">
            ...
            <div className="buttonContainer">
              {!fbLoggedIn && (
                ...
                >
                  <FacebookLoginButton style={{ backgroundColor: '#3b5998', color: 'white', fontWeight: 'bold', borderRadius: '4px', padding: '10px' }} />
                </LoginSocialFacebook>
              )}
              <GoogleLogIn onUserLogin={this.handleGoogleLogin} onSignOut={this.handleGoogleSignOut} />
